...
func (m *materializationSupportedResolver) SetEncryptedResolverState(request *wasm.SetEncryptedResolverStateRequest) (err error) {
	return m.current.SetEncryptedResolverState(request)
}
