...
type ResolvedFlag struct {
	...
	AssignmentOrigin string `protobuf:"bytes,7,opt,name=assignment_origin,json=assignmentOrigin,proto3" json:"assignment_origin,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ResolvedFlag) GetAssignmentOrigin() string {
	if x != nil {
...
const file_confidence_flags_resolver_v1_api_proto_rawDesc = "" +
	...
	"\n" +
	"apply_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tapplyTime\"\xd9\x02\n" +
	...
	"\fshould_apply\x18\x06 \x01(\bR\vshouldApply\x12+\n" +
	"\x11assignment_origin\x18\a \x01(\tR\x10assignmentOrigin2\x8e\x01\n" +
