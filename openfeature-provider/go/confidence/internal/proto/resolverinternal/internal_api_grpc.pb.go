...
func (UnimplementedInternalFlagLoggerServiceServer) ClientWriteFlagLogs(context.Context, *WriteFlagLogsRequest) (*WriteFlagLogsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClientWriteFlagLogs not implemented")
}
func (UnimplementedInternalFlagLoggerServiceServer) WriteMaterializedOperations(context.Context, *WriteOperationsRequest) (*WriteOperationsResult, error) {
	return nil, status.Error(codes.Unimplemented, "method WriteMaterializedOperations not implemented")
}
func (UnimplementedInternalFlagLoggerServiceServer) ReadMaterializedOperations(context.Context, *ReadOperationsRequest) (*ReadOperationsResult, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadMaterializedOperations not implemented")
}
...
func RegisterInternalFlagLoggerServiceServer(s grpc.ServiceRegistrar, srv InternalFlagLoggerServiceServer) {
	// If the following call panics, it indicates UnimplementedInternalFlagLoggerServiceServer was
