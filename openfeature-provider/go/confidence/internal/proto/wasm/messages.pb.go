...
func (x *SetResolverStateRequest) GetSdk() *resolver.Sdk {
	if x != nil {
		return x.Sdk
	}
	return nil
...
type SetEncryptedResolverStateRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	EncryptedState []byte                 `protobuf:"bytes,1,opt,name=encrypted_state,json=encryptedState,proto3" json:"encrypted_state,omitempty"`
...
func (x *SetEncryptedResolverStateRequest) Reset() {
	*x = SetEncryptedResolverStateRequest{}
	mi := &file_confidence_wasm_messages_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetEncryptedResolverStateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetEncryptedResolverStateRequest) ProtoMessage() {}

func (x *SetEncryptedResolverStateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_confidence_wasm_messages_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetEncryptedResolverStateRequest.ProtoReflect.Descriptor instead.
func (*SetEncryptedResolverStateRequest) Descriptor() ([]byte, []int) {
	return file_confidence_wasm_messages_proto_rawDescGZIP(), []int{2}
}

func (x *SetEncryptedResolverStateRequest) GetEncryptedState() []byte {
	if x != nil {
...
func (x *SetEncryptedResolverStateRequest) GetEncryptionKey() []byte {
	if x != nil {
...
func (x *SetEncryptedResolverStateRequest) GetSdk() *resolver.Sdk {
	if x != nil {
		return x.Sdk
	}
	return nil
...
type PrometheusSnapshotRequest struct {
	...
	BucketsPerDecade uint32                 `protobuf:"varint,2,opt,name=buckets_per_decade,json=bucketsPerDecade,proto3" json:"buckets_per_decade,omitempty"`
	Openmetrics      bool                   `protobuf:"varint,3,opt,name=openmetrics,proto3" json:"openmetrics,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *PrometheusSnapshotRequest) GetBucketsPerDecade() uint32 {
	if x != nil {
		return x.BucketsPerDecade
	}
	return 0
}

func (x *PrometheusSnapshotRequest) GetOpenmetrics() bool {
	if x != nil {
...
func (x *PrometheusSnapshotResponse) Reset() {
	*x = PrometheusSnapshotResponse{}
	mi := &file_confidence_wasm_messages_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrometheusSnapshotResponse) Descriptor() ([]byte, []int) {
	return file_confidence_wasm_messages_proto_rawDescGZIP(), []int{6}
}
...
const file_confidence_wasm_messages_proto_rawDesc = "" +
	...
	"\x03sdk\x18\x03 \x01(\v2!.confidence.flags.resolver.v1.SdkR\x03sdk\"\xa7\x01\n" +
	" SetEncryptedResolverStateRequest\x12'\n" +
	"\x0fencrypted_state\x18\x01 \x01(\fR\x0eencryptedState\x12%\n" +
	"\x0eencryption_key\x18\x02 \x01(\fR\rencryptionKey\x123\n" +
	"\x03sdk\x18\x03 \x01(\v2!.confidence.flags.resolver.v1.SdkR\x03sdk\"\x1d\n" +
	"\aRequest\x12\x12\n" +
...
var file_confidence_wasm_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_confidence_wasm_messages_proto_goTypes = []any{
	...
	(*SetEncryptedResolverStateRequest)(nil), // 2: confidence.wasm.SetEncryptedResolverStateRequest
	(*Request)(nil),                          // 3: confidence.wasm.Request
	(*Response)(nil),                         // 4: confidence.wasm.Response
	(*PrometheusSnapshotRequest)(nil),        // 5: confidence.wasm.PrometheusSnapshotRequest
	(*PrometheusSnapshotResponse)(nil),       // 6: confidence.wasm.PrometheusSnapshotResponse
	(*resolver.Sdk)(nil),                     // 7: confidence.flags.resolver.v1.Sdk
}
var file_confidence_wasm_messages_proto_depIdxs = []int32{
	7, // 0: confidence.wasm.SetResolverStateRequest.sdk:type_name -> confidence.flags.resolver.v1.Sdk
	7, // 1: confidence.wasm.SetEncryptedResolverStateRequest.sdk:type_name -> confidence.flags.resolver.v1.Sdk
...
func file_confidence_wasm_messages_proto_init() {
	...
	file_confidence_wasm_messages_proto_msgTypes[4].OneofWrappers = []any{
		(*Response_Data)(nil),
		(*Response_Error)(nil),
	}
	type x struct{}
