...
type Targeting_Criterion struct {
	...
	//	*Targeting_Criterion_MaterializedSegment
...
func (x *Targeting_Criterion) GetMaterializedSegment() *Targeting_Criterion_MaterializedSegmentCriterion {
	if x != nil {
		if x, ok := x.Criterion.(*Targeting_Criterion_MaterializedSegment); ok {
...
type Targeting_Criterion_MaterializedSegment struct {
	MaterializedSegment *Targeting_Criterion_MaterializedSegmentCriterion `protobuf:"bytes,3,opt,name=materialized_segment,json=materializedSegment,proto3,oneof"`
}
...
func (*Targeting_Criterion_MaterializedSegment) isTargeting_Criterion_Criterion() {}
...
type Targeting_Criterion_MaterializedSegmentCriterion struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
...
func (x *Targeting_Criterion_MaterializedSegmentCriterion) Reset() {
	*x = Targeting_Criterion_MaterializedSegmentCriterion{}
	mi := &file_confidence_flags_types_v1_target_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Targeting_Criterion_MaterializedSegmentCriterion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Targeting_Criterion_MaterializedSegmentCriterion) ProtoMessage() {}

func (x *Targeting_Criterion_MaterializedSegmentCriterion) ProtoReflect() protoreflect.Message {
	mi := &file_confidence_flags_types_v1_target_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Targeting_Criterion_MaterializedSegmentCriterion.ProtoReflect.Descriptor instead.
func (*Targeting_Criterion_MaterializedSegmentCriterion) Descriptor() ([]byte, []int) {
	return file_confidence_flags_types_v1_target_proto_rawDescGZIP(), []int{0, 1, 2}
}

func (x *Targeting_Criterion_MaterializedSegmentCriterion) GetMaterializedSegment() string {
	if x != nil {
		return x.MaterializedSegment
	}
	return ""
...
func (x *Expression_Operands) Reset() {
	*x = Expression_Operands{}
	mi := &file_confidence_flags_types_v1_target_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_confidence_flags_types_v1_target_proto_rawDesc = "" +
	"\n" +
	"&confidence/flags/types/v1/target.proto\x12\x19confidence.flags.types.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc4\x14\n" +
	"\tTargeting\x12N\n" +
	...
	"\x05value\x18\x02 \x01(\v2..confidence.flags.types.v1.Targeting.CriterionR\x05value:\x028\x01\x1a\x9c\a\n" +
	"\tCriterion\x12a\n" +
	"\tattribute\x18\x01 \x01(\v2A.confidence.flags.types.v1.Targeting.Criterion.AttributeCriterionH\x00R\tattribute\x12[\n" +
	"\asegment\x18\x02 \x01(\v2?.confidence.flags.types.v1.Targeting.Criterion.SegmentCriterionH\x00R\asegment\x12\x80\x01\n" +
	"\x14materialized_segment\x18\x03 \x01(\v2K.confidence.flags.types.v1.Targeting.Criterion.MaterializedSegmentCriterionH\x00R\x13materializedSegment\x1a\xbd\x03\n" +
	...
	"\asegment\x18\x01 \x01(\tR\asegment\x1aQ\n" +
	"\x1cMaterializedSegmentCriterion\x121\n" +
	"\x14materialized_segment\x18\x01 \x01(\tR\x13materializedSegmentB\v\n" +
	"\tcriterion\x1aM\n" +
	"\aAnyRule\x12B\n" +
...
var file_confidence_flags_types_v1_target_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_confidence_flags_types_v1_target_proto_goTypes = []any{
	...
	(*Targeting_Criterion_MaterializedSegmentCriterion)(nil), // 15: confidence.flags.types.v1.Targeting.Criterion.MaterializedSegmentCriterion
	(*Expression_Operands)(nil),                              // 16: confidence.flags.types.v1.Expression.Operands
...
var file_confidence_flags_types_v1_target_proto_depIdxs = []int32{
	...
	16, // 3: confidence.flags.types.v1.Expression.and:type_name -> confidence.flags.types.v1.Expression.Operands
	16, // 4: confidence.flags.types.v1.Expression.or:type_name -> confidence.flags.types.v1.Expression.Operands
	...
	15, // 8: confidence.flags.types.v1.Targeting.Criterion.materialized_segment:type_name -> confidence.flags.types.v1.Targeting.Criterion.MaterializedSegmentCriterion
	6,  // 9: confidence.flags.types.v1.Targeting.AnyRule.rule:type_name -> confidence.flags.types.v1.Targeting.InnerRule
	6,  // 10: confidence.flags.types.v1.Targeting.AllRule.rule:type_name -> confidence.flags.types.v1.Targeting.InnerRule
	7,  // 11: confidence.flags.types.v1.Targeting.InnerRule.eq_rule:type_name -> confidence.flags.types.v1.Targeting.EqRule
	8,  // 12: confidence.flags.types.v1.Targeting.InnerRule.set_rule:type_name -> confidence.flags.types.v1.Targeting.SetRule
	9,  // 13: confidence.flags.types.v1.Targeting.InnerRule.range_rule:type_name -> confidence.flags.types.v1.Targeting.RangeRule
	10, // 14: confidence.flags.types.v1.Targeting.EqRule.value:type_name -> confidence.flags.types.v1.Targeting.Value
	10, // 15: confidence.flags.types.v1.Targeting.SetRule.values:type_name -> confidence.flags.types.v1.Targeting.Value
	10, // 16: confidence.flags.types.v1.Targeting.RangeRule.start_inclusive:type_name -> confidence.flags.types.v1.Targeting.Value
	10, // 17: confidence.flags.types.v1.Targeting.RangeRule.start_exclusive:type_name -> confidence.flags.types.v1.Targeting.Value
	10, // 18: confidence.flags.types.v1.Targeting.RangeRule.end_inclusive:type_name -> confidence.flags.types.v1.Targeting.Value
	10, // 19: confidence.flags.types.v1.Targeting.RangeRule.end_exclusive:type_name -> confidence.flags.types.v1.Targeting.Value
	17, // 20: confidence.flags.types.v1.Targeting.Value.timestamp_value:type_name -> google.protobuf.Timestamp
	12, // 21: confidence.flags.types.v1.Targeting.Value.version_value:type_name -> confidence.flags.types.v1.Targeting.SemanticVersion
	11, // 22: confidence.flags.types.v1.Targeting.Value.list_value:type_name -> confidence.flags.types.v1.Targeting.ListValue
	10, // 23: confidence.flags.types.v1.Targeting.ListValue.values:type_name -> confidence.flags.types.v1.Targeting.Value
	7,  // 24: confidence.flags.types.v1.Targeting.Criterion.AttributeCriterion.eq_rule:type_name -> confidence.flags.types.v1.Targeting.EqRule
	8,  // 25: confidence.flags.types.v1.Targeting.Criterion.AttributeCriterion.set_rule:type_name -> confidence.flags.types.v1.Targeting.SetRule
	9,  // 26: confidence.flags.types.v1.Targeting.Criterion.AttributeCriterion.range_rule:type_name -> confidence.flags.types.v1.Targeting.RangeRule
	4,  // 27: confidence.flags.types.v1.Targeting.Criterion.AttributeCriterion.any_rule:type_name -> confidence.flags.types.v1.Targeting.AnyRule
	5,  // 28: confidence.flags.types.v1.Targeting.Criterion.AttributeCriterion.all_rule:type_name -> confidence.flags.types.v1.Targeting.AllRule
	1,  // 29: confidence.flags.types.v1.Expression.Operands.operands:type_name -> confidence.flags.types.v1.Expression
...
func file_confidence_flags_types_v1_target_proto_init() {
	...
	file_confidence_flags_types_v1_target_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*Targeting_Criterion_MaterializedSegment)(nil),
	}
