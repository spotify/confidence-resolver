...
export function sdkIdFromJSON(object: any): SdkId {
  switch (object) {
    ...
    case 16:
    case 'SDK_ID_RUST_CONFIDENCE':
      return SdkId.SDK_ID_RUST_CONFIDENCE;
    case 17:
    case 'SDK_ID_FLUTTER_IOS_CONFIDENCE':
      return SdkId.SDK_ID_FLUTTER_IOS_CONFIDENCE;
    case 18:
    case 'SDK_ID_FLUTTER_ANDROID_CONFIDENCE':
      return SdkId.SDK_ID_FLUTTER_ANDROID_CONFIDENCE;
    case 19:
    case 'SDK_ID_DOTNET_CONFIDENCE':
      return SdkId.SDK_ID_DOTNET_CONFIDENCE;
    case 20:
    case 'SDK_ID_GO_LOCAL_PROVIDER':
      return SdkId.SDK_ID_GO_LOCAL_PROVIDER;
    case 21:
    case 'SDK_ID_JAVA_LOCAL_PROVIDER':
      return SdkId.SDK_ID_JAVA_LOCAL_PROVIDER;
    case 22:
    case 'SDK_ID_JS_LOCAL_SERVER_PROVIDER':
      return SdkId.SDK_ID_JS_LOCAL_SERVER_PROVIDER;
    case -1:
    case 'UNRECOGNIZED':
    default:
...
export function sdkIdToJSON(object: SdkId): string {
  switch (object) {
    ...
    case SdkId.SDK_ID_RUST_CONFIDENCE:
      return 'SDK_ID_RUST_CONFIDENCE';
    case SdkId.SDK_ID_FLUTTER_IOS_CONFIDENCE:
      return 'SDK_ID_FLUTTER_IOS_CONFIDENCE';
    case SdkId.SDK_ID_FLUTTER_ANDROID_CONFIDENCE:
      return 'SDK_ID_FLUTTER_ANDROID_CONFIDENCE';
    case SdkId.SDK_ID_DOTNET_CONFIDENCE:
      return 'SDK_ID_DOTNET_CONFIDENCE';
    case SdkId.SDK_ID_GO_LOCAL_PROVIDER:
      return 'SDK_ID_GO_LOCAL_PROVIDER';
    case SdkId.SDK_ID_JAVA_LOCAL_PROVIDER:
      return 'SDK_ID_JAVA_LOCAL_PROVIDER';
    case SdkId.SDK_ID_JS_LOCAL_SERVER_PROVIDER:
      return 'SDK_ID_JS_LOCAL_SERVER_PROVIDER';
...
export const Sdk: MessageFns<Sdk> = {
  ...
  create<I extends Exact<DeepPartial<Sdk>, I>>(base?: I): Sdk {
    return Sdk.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Sdk>, I>>(object: I): Sdk {
    const message = createBaseSdk();
