...
export const ResolveFlagsRequest: MessageFns<ResolveFlagsRequest> = {
  ...
  fromJSON(object: any): ResolveFlagsRequest {
    return {
      ...
      evaluationContext: isObject(object.evaluationContext)
        ? object.evaluationContext
        : isObject(object.evaluation_context)
  ...
  fromJSON(object: any): ResolveFlagsResponse {
    return {
      resolvedFlags: globalThis.Array.isArray(object?.resolvedFlags)
        ...
        : globalThis.Array.isArray(object?.resolved_flags)
        ? object.resolved_flags.map((e: any) => ResolvedFlag.fromJSON(e))
        : [],
      resolveToken: isSet(object.resolveToken)
        ? bytesFromBase64(object.resolveToken)
        : isSet(object.resolve_token)
        ? bytesFromBase64(object.resolve_token)
        : new Uint8Array(0),
...
export const ApplyFlagsRequest: MessageFns<ApplyFlagsRequest> = {
  ...
  fromJSON(object: any): ApplyFlagsRequest {
    return {
      ...
      resolveToken: isSet(object.resolveToken)
        ...
        ? bytesFromBase64(object.resolve_token)
        : new Uint8Array(0),
      sendTime: isSet(object.sendTime)
        ? fromJsonTimestamp(object.sendTime)
        : isSet(object.send_time)
        ? fromJsonTimestamp(object.send_time)
        : undefined,
      sdk: isSet(object.sdk) ? Sdk.fromJSON(object.sdk) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ApplyFlagsRequest>, I>>(base?: I): ApplyFlagsRequest {
    return ApplyFlagsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ApplyFlagsRequest>, I>>(object: I): ApplyFlagsRequest {
    const message = createBaseApplyFlagsRequest();
...
export const ApplyFlagsResponse: MessageFns<ApplyFlagsResponse> = {
  ...
  create<I extends Exact<DeepPartial<ApplyFlagsResponse>, I>>(base?: I): ApplyFlagsResponse {
    return ApplyFlagsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ApplyFlagsResponse>, I>>(_: I): ApplyFlagsResponse {
    const message = createBaseApplyFlagsResponse();
    return message;
  },
};
...
export const AppliedFlag: MessageFns<AppliedFlag> = {
  ...
  create<I extends Exact<DeepPartial<AppliedFlag>, I>>(base?: I): AppliedFlag {
    return AppliedFlag.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AppliedFlag>, I>>(object: I): AppliedFlag {
    const message = createBaseAppliedFlag();
...
export const ResolvedFlag: MessageFns<ResolvedFlag> = {
  ...
  fromJSON(object: any): ResolvedFlag {
    return {
      ...
      flagSchema: isSet(object.flagSchema)
        ? FlagSchema_StructFlagSchema.fromJSON(object.flagSchema)
        : isSet(object.flag_schema)
        ? FlagSchema_StructFlagSchema.fromJSON(object.flag_schema)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<ResolvedFlag>, I>>(object: I): ResolvedFlag {
    ...
    message.flagSchema =
      object.flagSchema !== undefined && object.flagSchema !== null
        ? FlagSchema_StructFlagSchema.fromPartial(object.flagSchema)
        : undefined;
 ...
 */
export interface FlagResolverService {
  /**
   ...
   */
  ResolveFlags(request: ResolveFlagsRequest): Promise<ResolveFlagsResponse>;
}

export const FlagResolverServiceServiceName = 'confidence.flags.resolver.v1.FlagResolverService';
export class FlagResolverServiceClientImpl implements FlagResolverService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || FlagResolverServiceServiceName;
    this.rpc = rpc;
    this.ResolveFlags = this.ResolveFlags.bind(this);
  }
  ResolveFlags(request: ResolveFlagsRequest): Promise<ResolveFlagsResponse> {
    const data = ResolveFlagsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, 'ResolveFlags', data);
    return promise.then(data => ResolveFlagsResponse.decode(new BinaryReader(data)));
  }
}
