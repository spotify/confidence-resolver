...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESOLVEREASON']._serialized_end=625
  _globals['_SDKID']._serialized_start=628
  _globals['_SDKID']._serialized_end=1401
