...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RESOLVEREASON']._serialized_end=529
  _globals['_SDKID']._serialized_start=532
  _globals['_SDKID']._serialized_end=1207
